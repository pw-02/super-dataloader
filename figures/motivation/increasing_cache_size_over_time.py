...
total_cached_batches = df['total_cached_batches']
...
ax1.set_ylabel("Total Cached Batches", color="black")
...
ax2.yaxis.set_major_formatter(mticker.FuncFormatter(lambda x, _: f"{int(x/1024)}Tb"))
