...
for workload in workload_data:
    ...
    fig, (ax1, ax2, ax3) = plt.subplots(nrows=1, ncols=3, figsize=(15.4, 3.5))
    bar_width = 0.25
    ...
    ax1.set_xticklabels(x_tick_labels, fontsize=12)
    ...
    ax2.set_ylabel('Cost Per Epoch ($)', fontsize=12)
    ...
    ax3.set_xticklabels(x_tick_labels, fontsize=12)
