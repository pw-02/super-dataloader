...
workload_data['Resnet50/ImageNet'] = {
    "Thoughgput" : { "CoorDL": {'80': 572, '60': 359, '40': 262, '20': 206},
                    "Shade": {'80': 1398, '60': 572, '40': 572, '20': 359},
                    r'$\bf{SUPER}$': { '80': 1422, '60': 1435, '40': 1435, '20': 1435}},
    "Cost" : { "CoorDL": { '80': 54.57, '60': 74.9, '40':87.69, '20':92.3},
                "Shade": {'80': 26.7, '60': 54.57, '40':54.57, '20':92.3},
                r'$\bf{SUPER}$': {'80': 19.62, '60':19.62, '40': 19.62, '20': 19.62}},
    "CacheHit" : { "CoorDL": {'80': 25, '60': 50, '40': 75, '20': 100},
                    "Shade": {'80': 49, '60': 81, '40': 100, '20': 100},
                    r'$\bf{SUPER}$': {'80': 100, '60': 100, '40': 100, '20': 100}},
    "Time Breakdown": {
        "IO": { "CoorDL": { '80': 57, '60': 71, '40': 78, '20': 82},
                "Shade": {'80': 57, '60': 71, '40': 78, '20': 82},
                r'$\bf{SUPER}$': { '80': 2, '60': 2, '40': 2, '20': 2}},
        "Transform": { "CoorDL": { '80': 5, '60': 4, '40': 4, '20': 4},
                        "Shade": {'80': 5, '60': 4, '40': 4, '20': 4},
                        r'$\bf{SUPER}$': {'80': 2, '60': 2, '40': 2, '20': 2}},
        "GPU": { "CoorDL": { '80': 38, '60': 24, '40': 17, '20': 13},
                "Shade": { '80': 38, '60': 24, '40': 17, '20': 13},
                r'$\bf{SUPER}$': {'80': 94, '60': 94, '40': 94, '20': 94}},
    }}

workload_data['ViT-32/Cifar10'] = {
    "Thoughgput" : { "CoorDL": { '80': 1544, '60': 911, '40': 644, '20': 456},
                    "Shade": { '80': 1544, '60': 911, '40': 644, '20': 456},
                    r'$\bf{SUPER}$': { '80': 1567, '60': 1567, '40': 1567, '20': 1567}},
    "Cost" : { "CoorDL": { '80': 0.580, '60': 0.88, '40':1.20, '20':1.64},
                "Shade": { '80': 0.580, '60': 0.88, '40':1.20, '20':1.64},
                r'$\bf{SUPER}$': { '80': 0.348, '60':0.348, '40': 0.348, '20': 0.348}},
    "CacheHit" : { "CoorDL": { '80': 25, '60': 50, '40': 75, '20': 100},
                    "Shade": { '80': 49, '60': 81, '40': 100, '20': 100},
                    r'$\bf{SUPER}$': { '80': 100, '60': 100, '40': 100, '20': 100}},
    "Time Breakdown": {
        "IO": { "CoorDL":  { '80': 6, '60': 41, '40': 57, '20': 69},
                "Shade": { '80': 6, '60': 41, '40': 57, '20': 69},
                r'$\bf{SUPER}$': { '80': 2, '60': 2, '40': 2, '20': 2}},
        "Transform": { "CoorDL": { '80': 2, '60': 5, '40': 4, '20': 4},
                        "Shade": { '80': 2, '60': 5, '40': 4, '20': 4},
                        r'$\bf{SUPER}$': {'80': 3, '60': 3, '40': 3, '20': 3}},
        "GPU": { "CoorDL": { '80': 93, '60': 54, '40': 38, '20': 27},
                "Shade": { '80': 93, '60': 54, '40': 38, '20': 27},
                r'$\bf{SUPER}$': { '80': 95, '60': 95, '40': 95, '20': 95}},
    }}
