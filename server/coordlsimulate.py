...
DELAY_BETWEEN_JOBS = 30  # Delay in seconds between the start of each job
...
args:CoorDLArgs = CoorDLArgs(
            ...
            serverless_cache_address = '127.0.0.1:6379',
            shuffle = False,
            drop_last = False,
...
dataset = CoorDLDataset(data_dir=cf10,
                        batch_size=128, 
                        drop_last=False, 
                        kind=args.workload_kind)

batch_manager = CoorDLBatchManager(dataset=dataset, args=args)
