...
class CoorDLDataset(BaseDataset):
    def __init__(self, data_dir: str, batch_size: int, drop_last: bool, kind = 'vision', max_dataset_size = None):
        # Load samples from data directory
        self.data_dir = data_dir
        self.batch_size = batch_size
        samples = self.load_paired_s3_object_keys(data_dir, False, True)
...
class Dataset(BaseDataset):
    def __init__(self, data_dir: str, batch_size: int, drop_last: bool, num_partitions: int = 10, kind = 'vision', max_dataset_size = None):
        # Load samples from data directory
        self.data_dir = data_dir
        self.batch_size = batch_size
